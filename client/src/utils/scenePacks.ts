...
function sanitizeLowerThird(input: unknown): LowerThirdData | null {
  ...
  lowerThird.animationDirection = normalizeLowerThirdAnimationDirection(input.animationDirection);
  lowerThird.fontFamily = normalizeLowerThirdFont(input.fontFamily);
