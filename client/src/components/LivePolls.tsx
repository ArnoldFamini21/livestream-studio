...
const styles: Record<string, React.CSSProperties> = {
  ...
  pollStatus: { fontSize: 10, fontWeight: 800, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: '0.04em' },
  ...
  voteOptionSelected: { borderColor: 'rgba(167, 139, 250, 0.42)', color: 'var(--text-primary)' },
  voteFill: { position: 'absolute', inset: '0 auto 0 0', background: 'rgba(167, 139, 250, 0.12)', pointerEvents: 'none' },
  voteIndex: { position: 'relative', width: 22, height: 22, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', borderRadius: 6, background: 'rgba(255,255,255,0.08)', color: 'var(--accent-hover)', fontSize: 11, fontWeight: 900, fontVariantNumeric: 'tabular-nums' },
...
const overlayStyles: Record<string, React.CSSProperties> = {
  ...
  badge: { fontSize: 11, fontWeight: 900, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: '0.08em' },
  ...
  optionFill: { position: 'absolute', inset: '0 auto 0 0', background: 'rgba(167, 139, 250, 0.25)', pointerEvents: 'none' },
  optionIndex: { position: 'relative', width: 24, height: 24, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', borderRadius: 6, background: 'rgba(255,255,255,0.12)', color: 'var(--accent-hover)', fontSize: 12, fontWeight: 900, fontVariantNumeric: 'tabular-nums' },
  ...
  optionPercent: { position: 'relative', color: 'var(--accent-hover)', fontSize: 12, fontWeight: 900, fontVariantNumeric: 'tabular-nums' },
};
