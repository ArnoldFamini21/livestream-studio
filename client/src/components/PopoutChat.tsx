...
const styles: Record<string, React.CSSProperties> = {
  ...
  pinnedBanner: { border: '1px solid rgba(167, 139, 250, 0.26)', borderRadius: 8, background: 'rgba(167, 139, 250, 0.08)', padding: '9px 10px', display: 'flex', alignItems: 'center', gap: 8 },
  pinnedLabel: { flexShrink: 0, fontSize: 9, fontWeight: 900, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: 0 },
  ...
  messageCardPinned: { borderColor: 'rgba(167, 139, 250, 0.3)', background: 'rgba(167, 139, 250, 0.055)' },
  ...
  pinBadge: { fontSize: 9, fontWeight: 800, color: 'var(--accent)', background: 'rgba(167, 139, 250, 0.12)', borderRadius: 999, padding: '2px 6px', textTransform: 'uppercase', letterSpacing: 0 },
  ...
  actionButtonPinned: { color: 'var(--accent)', borderColor: 'rgba(167, 139, 250, 0.32)', background: 'rgba(167, 139, 250, 0.12)' },
