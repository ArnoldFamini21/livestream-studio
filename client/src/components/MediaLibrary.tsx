...
const styles: Record<string, React.CSSProperties> = {
  ...
  deckControl: { margin: '10px 12px 8px', padding: 12, borderRadius: 8, border: '1px solid rgba(167, 139, 250,0.24)', background: 'rgba(167, 139, 250,0.07)' },
  deckControlHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginBottom: 7 },
  deckEyebrow: { fontSize: 10, fontWeight: 800, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: 0 },
  ...
  deckPresenterCardCurrent: { border: '1px solid rgba(167, 139, 250,0.34)', background: 'rgba(8,47,73,0.28)' },
  ...
  deckPresenterLabel: { fontSize: 8, fontWeight: 900, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: 0 },
  ...
  deckNotes: { marginTop: 9, padding: '8px 9px', borderRadius: 7, border: '1px solid rgba(167, 139, 250,0.18)', background: 'rgba(2,6,23,0.28)' },
  deckNotesHeader: { fontSize: 9, fontWeight: 900, color: 'var(--accent)', textTransform: 'uppercase', letterSpacing: 0, marginBottom: 5 },
  ...
  deckJumpSelect: { minWidth: 0, width: '100%', height: 30, padding: '0 8px', borderRadius: 7, border: '1px solid rgba(167, 139, 250,0.22)', background: 'rgba(15,23,42,0.72)', color: 'var(--text-primary)', fontSize: 11, fontWeight: 700, outline: 'none' },
  ...
  deckReadinessNoticeChecking: { border: '1px solid rgba(167, 139, 250,0.3)', background: 'rgba(167, 139, 250,0.08)' },
  ...
  assetCardProcessing: { border: '1px solid rgba(167, 139, 250,0.34)', background: 'rgba(167, 139, 250,0.07)' },
  ...
  assetIconProcessing: { color: 'var(--accent)', background: 'rgba(167, 139, 250,0.12)' },
  ...
  assetMetaProcessing: { color: 'var(--accent)', lineHeight: 1.25, whiteSpace: 'normal' },
